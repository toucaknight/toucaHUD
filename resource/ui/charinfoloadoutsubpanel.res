...
"Resource/UI/CharInfoLoadoutSubPanel.res"
{
	"LeftBG"
	{
		...
		"ypos"										"0"
		"zpos"										"-1"
		"wide"										"p0.158" //p0.001 equals 2 pixes but you have to check this on paint.NET, and check the pixels there.
		"tall"										"f0"
		"visible"									"1"
		"enabled"									"1"
		"paintbackground"							"1"
	...
	"ScoutCustom"
	{
		...
		"ypos"										"25"
		"zpos"										"605"
		"wide"										"p0.045" // for example, def wdie is 40, but equals 90 pixels on paint dot net, so we do the math, 90 / 2 = p0.0
		"tall"										"52"
		"visible"									"1"
		"enabled"									"1"
